...
@property NSDictionary *spirodata;
...
- (NSArray *)monthlyAaplPrices
{
    ...
    NSString* fileRoot = [[NSBundle mainBundle] pathForResource:@"spirodata" ofType:@""];
    ...
    while (fgets(buffer, 256, file) != NULL){
        ...
        [prices addObject:[[NSDecimalNumber alloc] initWithFloat:(100*f)]]; // multiply by 100 so it will be an integer value (easier to display with core plot)
    }
